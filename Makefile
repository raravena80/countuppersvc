GOPKG_BASE := github.com/raravena80/countuppersvc
...
build: workdir/countuppersvc

build-native: $(GOFILES)
	go build $(GO_LDFLAGS) -o workdir/countuppersvc .

workdir/countuppersvc: $(GOFILES)
	GOOS=linux GOARCH=amd64 CGO_ENABLED=0 go build $(GO_LDFLAGS) -o workdir/countuppersvc.linux.amd64 .
